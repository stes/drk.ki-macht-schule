...
export let ownDatasets: {[key: string]: dataset.DataGenerator} = {
  "dogs": dataset.classifyDogs,
  "dogs2": dataset.classifyDogs2,
  "dogs3": dataset.classifyDogs3,
};
...
export let problems = {
  ...
  "own": Problem.REAL_CLASSIFICATION,
};
...
export class State {
  ...
  private static PROPS: Property[] = [
    ...
    {name: "ownDataset", type: Type.OBJECT, keyMap: ownDatasets},
  ...
  ownDataset: dataset.DataGenerator = dataset.classifyDogs2;
  seed: string;
